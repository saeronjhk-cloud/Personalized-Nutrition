  ...
  return (
    <div className="page fade-in" style={{ paddingTop: 'var(--space-8)', paddingBottom: 60 }}>
      ...
      <div className="card" style={{ lineHeight: 1.8, fontSize: 14, color: 'var(--text-secondary)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>1. 수집하는 정보 항목</h3>
        <p style={{ marginBottom: 'var(--space-2)' }}>
          회사는 다음과 같은 정보를 설문 완료 시점 또는 회원가입 시 수집합니다.
        </p>
        <p style={{ marginBottom: 'var(--space-2)', fontWeight: 600, color: 'var(--text)' }}>① 비회원 이용 시 (회원가입 없음)</p>
        ...
        <p style={{ marginBottom: 'var(--space-2)', fontWeight: 600, color: 'var(--text)' }}>② 회원가입 시 (선택)</p>
        <ul style={{ marginBottom: 'var(--space-4)', paddingLeft: 'var(--space-5)' }}>
        ...
        <p style={{ marginBottom: 'var(--space-2)', fontWeight: 600, color: 'var(--text)' }}>③ 제품 스캔 이용 시 (로그인 회원)</p>
        <ul style={{ marginBottom: 'var(--space-4)', paddingLeft: 'var(--space-5)' }}>
        ...
        <p style={{ marginBottom: 'var(--space-2)', fontWeight: 600, color: 'var(--text)' }}>민감정보(건강에 관한 정보)의 별도 동의</p>
        <p style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>2. 수집 및 이용 목적</h3>
        <ul style={{ marginBottom: 'var(--space-4)', paddingLeft: 'var(--space-5)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>3. 보유 기간 및 파기</h3>
        <ul style={{ marginBottom: 'var(--space-4)', paddingLeft: 'var(--space-5)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>4. 처리위탁 및 국외 이전</h3>
        <p style={{ marginBottom: 'var(--space-4)' }}>
        ...
        {[
          {
            ...
            basis: MEAL_ENABLED
              ? '「개인정보 보호법」 제28조의8 제1항 제3호 가목(정보주체와의 계약 이행에 필요한 국외 처리위탁·보관으로서 본 처리방침을 통해 공개). 원본 데이터는 서울 리전에 저장되며, 운영·기술지원 과정에서 국외 조회가 있을 수 있어 국외이전으로 고지합니다(별도 동의 대상에서는 제외).'
          ...
          ...(MEAL_ENABLED ? [
            {
              ...
              purpose: '사진 기반 음식·영양 분석 연산 — 사진 파일을 영속 저장하지 않고 요청 처리 중 일시적으로만 처리하며, 회원번호·이메일 등 식별정보 대신 무작위 요청식별자만 사용',
            ...
            {
              name: 'OpenAI OpCo, LLC', country: '미국(및 OpenAI 하위처리자 소재 국가)',
          ...
          <div key={v.name} className="card" style={{ padding: 'var(--space-3) 14px', marginBottom: 'var(--space-3)', fontSize: 13, lineHeight: 1.7 }}>
            <div style={{ fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-1)' }}>{v.name} <span style={{ fontWeight: 400, color: 'var(--text-muted)' }}>· 이전 국가: {v.country}</span></div>
        ...
        {MEAL_ENABLED && (
          <p style={{ marginBottom: 'var(--space-4)', fontSize: 13, color: 'var(--text-muted)' }}>
            ⓘ <strong>식사 사진의 처리 흐름과 최소 전송</strong> — 회사는 식사 사진 분석 과정에서 <strong>원본 식사 사진을 대한민국(서울) 소재 비공개 저장소(Supabase)에 보관</strong>하고,
        ...
        {MEAL_ENABLED && (
          <p style={{ marginBottom: 'var(--space-4)', fontSize: 13, color: 'var(--text-muted)' }}>
            ...
            분석 결과는 지체 없이 삭제됩니다.</strong> <strong>계정 및 그 밖의 서비스는 계속 이용</strong>할 수 있습니다. 백업본에 남아 있는 정보는 복구 목적 외에는 이용되지 않으며, 정해진 백업 보유주기(현재 플랜 기준 7일)가 지나면 자동 파기됩니다.
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>5. 쿠키 및 로컬 저장소</h3>
        <p style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>6. 제3자 링크</h3>
        <p style={{ marginBottom: 'var(--space-4)' }}>
          본 서비스는 쿠팡 등 외부 쇼핑몰 검색 링크를 제공합니다. 외부 사이트의 개인정보처리방침은
          해당 사이트의 정책을 따르며, 회사는 이에 대한 책임을 지지 않습니다.
        </p>

        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>7. 이용자의 권리</h3>
        <p style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>8. 개인정보 보호책임자 및 사업자 정보</h3>
        <p style={{ marginBottom: 'var(--space-4)' }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 'var(--space-2)' }}>10. 개인정보의 안전성 확보조치</h3>
        <ul style={{ marginBottom: 'var(--space-4)', paddingLeft: 'var(--space-5)' }}>
          ...
          <li>장애 복구용 데이터베이스 백업은 현재 운영 플랜 기준 7일간 보관 후 순차적으로 파기합니다.</li>
        </ul>
