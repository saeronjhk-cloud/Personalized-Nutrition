  ...
  return (
    <div className="page fade-in">
      ...
      <section className="content-section">
        <h2 className="section-title" style={{ textAlign: 'center', marginBottom: 'var(--space-2)' }}>우리가 모인 이유</h2>
        <p className="section-desc" style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto var(--space-8)' }}>
          학계와 산업계에서 평생을 바친 전문가들이 하나의 질문 앞에 모였습니다.
        </p>

        <div className="about-story-card card" style={{ padding: '40px var(--space-8)', marginBottom: 'var(--space-8)' }}>
          <blockquote className="about-quote">
            "사람들은 왜 자기 몸에 필요한 영양소조차 제대로 모를까?"
          </blockquote>
          <p style={{ lineHeight: 1.9, fontSize: 15, color: 'var(--text-secondary)', marginTop: 'var(--space-6)' }}>
            연구실에서 성분을 분석하던 사람, 공장에서 원료를 만들던 사람,
            강단에서 영양학을 가르치던 사람 — 각자의 자리에서 수십 년을 보낸
            전문가들이 같은 문제의식을 품고 있었습니다.
          </p>
          <p style={{ lineHeight: 1.9, fontSize: 15, color: 'var(--text-secondary)', marginTop: 'var(--space-4)' }}>
            건강기능식품 시장은 매년 커지는데, 정작 소비자는 광고와 입소문에
            의존해 영양제를 고릅니다. 내 몸에 진짜 필요한 게 뭔지 알려주는 곳은
            어디에도 없었습니다.
          </p>
          <p style={{ lineHeight: 1.9, fontSize: 15, marginTop: 'var(--space-4)' }}>
          ...
          <div className="grid-3" style={{ marginBottom: 0, flex: 1 }}>
            {[
              ...
              <div key={i} className="card" style={{ textAlign: 'center', padding: 'var(--space-6)' }}>
                ...
                <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 'var(--space-2)' }}>{item.title}</h3>
      ...
      <section className="cta-section">
        ...
        <Link to="/survey" className="btn btn-primary" style={{ maxWidth: 320, margin: 'var(--space-4) auto 0' }}>
          ✨ 무료 분석 시작하기
        </Link>
      </section>
    </div>
